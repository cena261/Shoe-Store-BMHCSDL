...
------------------------------------------------
CREATE TABLE ROLES (
                       ROLEID    NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE CATEGORIES (
                            CATEGORYID    NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE PRODUCTIMAGES (
                               IMAGEID       NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
                               PRODUCTID     NUMBER(10)      NOT NULL,
...
CREATE TABLE REVIEWS (
                         REVIEWID    NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
                         PRODUCTID   NUMBER(10)      NOT NULL,
                         USERID      NUMBER(10)      NOT NULL,
...
------------------------------------------------
CREATE TABLE ORDERS (
                        ORDERID            NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
                        USERID             NUMBER(10)      ,
...
CREATE TABLE ORDERITEMS (
                            ORDERITEMID  NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
...
------------------------------------------------
CREATE TABLE CART (
                      CARTID     NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
                      USERID     NUMBER(10)      NOT NULL,
                      VARIANTID  NUMBER(10)      NOT NULL,
                      QUANTITY   NUMBER(10)      NOT NULL,
...
CREATE TABLE PASSWORDRESETTOKENS (
                                     TOKENID    NUMBER(10) GENERATED BY DEFAULT AS IDENTITY,
                                     EMAIL      NVARCHAR2(255)  NOT NULL,
